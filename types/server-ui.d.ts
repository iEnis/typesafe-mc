...
export class ModalFormData<T extends any[] = []> {
     ...
     * Text to display.
     */
    label(text: minecraftserver.RawMessage | string): ModalFormData<T>;
    /**
     * @remarks
     * Creates and shows this modal popup form. Returns
     * asynchronously when the player confirms or cancels the
     ...
     *
     */
    title(titleText: minecraftserver.RawMessage | string): ModalFormData<T>;
    /**
     * @remarks
 ...
 */
// @ts-ignore Class inheritance allowed for native defined classes
export class ModalFormResponse<T extends any[]> extends FormResponse {
    private constructor();
    /**
     * @remarks
